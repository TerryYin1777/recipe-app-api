...
class PublicUserApiTests(TestCase):
    """Test the publicly available user endpoints"""
    def setUp(self):
    ...
    def test_create_user_with_email_exists(self):
        """Test create user when email is already taken"""
        payload = {
            "email": "test@example.com",
            "password": "testpass123",
            "name": "Test User"
    ...
    def test_create_user_token_success(self):
        """Test create and return user token"""
        user_info = {
            "email": "test@example.com",
            "password": "testpass123",
            "name": "Test Name"
    ...
    def test_create_token_with_black_password(self):
        """Test create token with no password"""
        payload = {
            "email": "test@example.com",
            "password": ""
        }
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        """Set up the authenticated test user"""
